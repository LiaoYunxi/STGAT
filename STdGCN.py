...
def run_STdGCN(paths,
    ...
    # 在这里把ST_adata_filter_norm,pseudo_adata_norm,ST_integration中的基因表达换为topic嵌入；注意marker基因数量，不能太少，在stride中大概1000个
    # 1.使用sc数据生成topic model
    
    
    # 2.将三个adata的基因表达矩阵转换为topic嵌入矩阵
